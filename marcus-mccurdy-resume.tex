  ...
  {\bodytext{
      \begin{itemize}
          ...
          \item Worked closely with operational analysts to provide custom
              reporting on 50's internal {PHP} dashbaord and {MySQL} database.
          ...
          \item Revolutionised 50's Python webscraping framework by rewriting
          ...
          \item Implemented a concurrent Java application to process and 
              aggregate terabytes of Akamai logfiles daily and store them
